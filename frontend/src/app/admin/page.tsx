...
type Tab = "dashboard" | "zones" | "commerces" | "dealers" | "orders";
...
interface Product { id: string; commerce_id: string | null; category_id: string; name: string; price: number; is_available: number; description: string; image_url: string | null; }
